...
import ticketmodeling.domain.model.audience.type.JuniorHandicappedAudience;
...
class JuniorHandicappedAudienceTest extends AudienceTestTemplate<JuniorHandicappedAudience>
{
	...
	class 映画の日 extends AudienceTestTemplate.映画の日 {
		@Test
		void 時間が1959の場合() {
			assertThat(getAudience().calcPrice(scheduledTime_1959), is(getAssertionPrice(900)));
		}
		@Test
		void 時間が2000の場合() {
			assertThat(getAudience().calcPrice(scheduledTime_2000), is(getAssertionPrice(900)));
		}
		@Test
		void 時間が2001の場合() {
			assertThat(getAudience().calcPrice(scheduledTime_2001), is(getAssertionPrice(900)));
		}
	}
	@Nested
